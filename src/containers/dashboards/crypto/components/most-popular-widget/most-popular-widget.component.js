          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell className={classes['table-cell']}>Clinet</TableCell>
                <TableCell className={classes['table-cell']} numeric>Bill</TableCell>
                <TableCell className={classes['table-cell']} numeric>Due</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {data.map(item => (
